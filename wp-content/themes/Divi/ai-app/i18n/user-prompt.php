...
return array(
	...
	'Generate Section With AI'                         => esc_html__( 'Generate Section With AI', 'Divi' ),
	'$sectionDescTitle'                                => esc_html__( 'Describe The Section You Want Divi AI To Create', 'Divi' ),
	'$sectionDescHint'                                 => esc_html__( 'Describe the section you want Divi AI to create. If there are specific elements, colors or fonts you want to use, let it know! Or, keep it simple and let Divi AI run with it.', 'Divi' ),
	'$sectionDescPlaceholder'                          => esc_html__( 'Example: Create a services section that describes our solar installation services.', 'Divi' ),
	'Generate Section'                                 => esc_html__( 'Generate Section', 'Divi' ),
	'Generating Section'                               => esc_html__( 'Generating Section', 'Divi' ),
	'Images'                                           => esc_html__( 'Images', 'Divi' ),
	'$ImagesHint'                                      => esc_html__( 'Divi AI will fill your layouts with relevant photos and images automatically. Using stock photos is the fastest and most reliable option. You can also generate completely unique images using AI, which takes longer but can result in a wider variety of unique images.', 'Divi' ),
